...
using ApiAstromania.Models;
using System.Data;
using System.Data.SqlClient;

namespace ApiAstromania.Controllers
{
    ...
    public class ProductoController : ControllerBase
    {
        ...
        [Route("ObtenerPorId/{idProducto:int}")]
        public IActionResult ObtenerPorId(int idProducto)
        {
        ...
        // modificar la base de datos de la api con el dashboard
        [HttpPost]
        [Route("Guardar")]
